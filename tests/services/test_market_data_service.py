...
class TestMarketDataService:
    ...
    def test_get_all_prices_empty_market(self, service):
    ...
    def test_get_all_prices_api_failure(self, service):
    ...
    def test_get_all_prices_not_initialized(self, service):
        """Test get_all_prices raises when service not initialized."""
        service.hyperliquid.get_info_client.side_effect = RuntimeError("not initialized")
    ...
    def test_get_price_api_failure(self, service):
    ...
    def test_get_market_info_success(self, service):
    ...
    def test_get_market_info_empty_universe(self, service):
    ...
    def test_get_market_info_api_failure(self, service):
    ...
    def test_get_order_book_success(self, service):
    ...
    def test_get_order_book_empty_coin(self, service):
    ...
    def test_get_order_book_none_coin(self, service):
        """Test get_order_book raises with None coin symbol."""
        with pytest.raises(ValueError, match="Coin symbol is required"):
            service.get_order_book(None)

    def test_get_order_book_api_failure(self, service):
    ...
    def test_get_asset_metadata_success(self, service):
    ...
    def test_get_asset_metadata_not_found(self, service):
    ...
    def test_get_asset_metadata_empty_universe(self, service):
    ...
    def test_get_asset_metadata_api_failure(self, service):
