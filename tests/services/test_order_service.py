...
class TestOrderService:
    ...
    @pytest.fixture
    def service(self, mock_hyperliquid_service, mock_settings):
        """Create OrderService instance with mocked dependencies."""
        with patch('src.services.order_service.hyperliquid_service', mock_hyperliquid_service):
            svc = OrderService()
    ...
    def test_list_open_orders_success(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_list_open_orders_empty(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_list_open_orders_api_failure(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_market_order_buy_success(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_market_order_sell_success(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_market_order_api_error_response(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_market_order_api_failure(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_limit_order_buy_success(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_limit_order_sell_success(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_limit_order_with_ioc_tif(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_limit_order_with_alo_tif(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_place_limit_order_api_error_response(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_cancel_order_success(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_cancel_order_api_error_response(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_cancel_order_api_failure(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_cancel_all_orders_success(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_cancel_all_orders_no_open_orders(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_cancel_all_orders_partial_failure(self, service, mock_hyperliquid_service, mock_settings):
    ...
    def test_cancel_all_orders_list_failure(self, service, mock_hyperliquid_service, mock_settings):
